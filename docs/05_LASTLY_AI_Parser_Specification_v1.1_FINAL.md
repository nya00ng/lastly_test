...
01~04 Final Sync에서 확정한 내용을 반영하되, **Validation Dataset v1.1과의 호환성을 유지하되 Parser JSON Schema는 `schema_version = "1.0"`을 유지한다.**
...
08 `LASTLY AI Validation Dataset v1.1 FINAL`은 다음 계약을 기준으로 유지 가능하다.
