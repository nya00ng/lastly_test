...
# 17. 현재 G0 상태
01~09와 본 10번은 v1.1 기준으로 정리되었지만 G0는 아직 PASS가 아니다. 11·12 v1.1 FINAL 생성 후 01~12 Cross-document Audit와 Freeze가 필요하다.
...
11/12 생성 후 01~12에서 Core MUST25, API MUST21/SHOULD6, Intent6, Scope3, Lifecycle6, Clarification4, NO_HISTORY, IMPLICIT_TODAY, Manual Record, Item Matching, Device Notification, Snooze 1/3/7, Atomic Multi-save, DB-HARDEN-001을 대조한다.
...
- SHOULD 비차단: 반영
- Codex Workflow: 반영
- **현재 G0: 미통과 — 11/12 및 01~12 Cross-document Audit 필요**
- **Runtime 구현: 아직 시작 전**
